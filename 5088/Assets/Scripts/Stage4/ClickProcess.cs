...
public class ClickProcess : MonoBehaviour
{
    ...
    [SerializeField] RobotManager4 robotManager4;   // 로봇 매니저 가져오기
    ...
    private void Update()
    {
        ...
        if(Stage4Game.s4_game == Stage4Game.S4GAME.CLEAR || Stage4Game.s4_game == Stage4Game.S4GAME.DEAD)
